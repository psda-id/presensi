...
const Dashboard = (() => {
    ...
    function renderHero() {
        ...
        title.innerHTML =
            `Selamat Datang,<br>${data.nama}`;

        hero.src =
            data.link_foto_profile ||
            "assets/logo.png";
    ...
    function renderTools() {
        ...
        const container =
            document.getElementById("mainTools");
    ...
    function renderLapkin() {
        ...
        const container =
            document.getElementById("lapkinContainer");
    ...
    function renderAgenda() {
        ...
        const select =
            document.getElementById("agnNama");
