...
// ✅ BUG 2 FIX: FACE API LOADER DENGAN TIMEOUT 10 DETIK
...
function showUpdateModal() {
    ...
    // ✅ BUG 1 FIX: Hapus parameter true
...
// ✅ BUG 4 FIX: Tambahkan timeout 10 detik jika image corrupt
...
// ✅ GPS FIX: Blok presensi jika akurasi > 250m
function upLoc() {
...
function startSelfieOverlay() {
    ...
    if (DeviceProfile.config.enableFaceAPI && DeviceProfile.config.detectInterval > 0) {
        const runDetection = async () => {
            // ✅ BUG 3 FIX: Cek videoWidth eksplisit
...
// ✅ BUG 5 FIX: Try-catch quota, simpan tanpa foto jika penuh
// ✅ EXPIRY FIX: Hapus data jika > 24 jam
...
function loadAutoRecovery() { 
    ...
    if (saved) { 
        ...
        if (data.timestamp && (Date.now() - data.timestamp < 86400000)) {
            ...
            sessionStorage.removeItem('pusda_recovery'); // Hapus jika kedaluwarsa
        }
    } 
}
...
// ✅ BUG 7 FIX: Jika API gagal dan cache kosong, tampilkan UI retry
// ✅ CACHE FIX: Tambahkan try-catch quota di localStorage
